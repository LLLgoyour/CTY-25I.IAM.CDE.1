...
\begin{enumerate}
    ...
    \item Statement 3: $2 - \sqrt{2}$ is an irrational number.\newline
          ...
          \[
              x^2 = 6 - 4\sqrt{2} \Rightarrow \sqrt{2} = -\frac{x^2-6}{4}
          \]
          Since \(x\) is a rational number, \(-\frac{x^2-6}{4}\) is a rational number.\newline
          Since \(\sqrt{2}\) is irrational, \(-\frac{x^2-6}{4}\) is irrational, which contradicts
          with the previous induction.\newline
