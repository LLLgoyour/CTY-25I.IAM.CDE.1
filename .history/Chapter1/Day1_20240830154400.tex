    ...
    \item Statement 1: If $x$ is an integer then $x^2 \geq x$.
          \begin{itemize}
              ...
              \item Case 4: $x < 0$.\newline
                    ...
                    Therefore, for all integers \(x\), \(x^2 \geq x\) is true.\newline (I am confident that the justification I gave is conclusive)
          \end{itemize}
          ...
          \begin{itemize}
              ...
              \item Case 4: $x < 0$.\newline
                    ...
                    \[
                        x^3 = -a^3 < -a = x
                    \]
                    So, the statement is false when $x < 0$.\newline
                    Therefore, for integers \(x < 0\), \(x^3 \geq x\) is false.
          \end{itemize}
    \item Statement 3: Justification (if conclusive)
\end{enumerate}
