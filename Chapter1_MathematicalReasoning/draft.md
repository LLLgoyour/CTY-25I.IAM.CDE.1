...
15. For any positive real number $x$, there exists a positive real number $y$ such that $y^2 = x$.done
16. Given three distinct points in space, there is one and only one plane passing through them.done
